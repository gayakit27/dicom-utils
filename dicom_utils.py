...
def get_contour_data(rs_dataset): #Extracting the contour positioning acording to ROI and the color of each contour
    contour_data = {}
    contour_color = {}
...
def load_contour_slices(rs_dataset): # extracting from the RS file the data of each slice and organizing it according to ROIs
    contour_slices = {}
    roi_contour_sequence = rs_dataset.ROIContourSequence
    structure_set_ROI_sequence = rs_dataset.StructureSetROISequence
...
def re_sort1(ct_slices): # sorting the CT images in an increasing order, the most bottom image is first...
    slices_order = []
